...
<style scoped lang="css">
  ...
  .toast {
    @apply flex ;
    @apply p-1 text-base font-bold rounded-lg shadow-btn dark:shadow-btn-dark;
    max-width: 400px;
  }
  .toast .main {
    @apply w-60 md:w-96 bg-[#FFFFFF] dark:bg-[#121927] ml-4 p-4 rounded-r-lg flex items-center;
  }
  .toast-close-btn {
