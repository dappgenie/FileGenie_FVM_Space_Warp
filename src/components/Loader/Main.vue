...
import loader from '../../assets/images/Lamp.gif'
</script>
<template>
    <div class="z-40 absolute top-0 w-screen h-screen background flex items-center justify-center">
      <div class="flex flex-col justify-center items-center space-y-4 text-center">
        <img h-48 alt="Loading" :src="loader">
  ...
  .fountainTextG{
    @apply text-color-secondary font-primary text-2xl font-semibold;
